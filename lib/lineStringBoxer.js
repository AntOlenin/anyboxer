 ...
 * */
LineStringBoxer.prototype.getBoxes = function(featureLineString) {
    var coordinates = featureLineString.geometry.coordinates;
    var fat = featureLineString.properties.fat;

    var mainBox = this.getMainBox(coordinates);
    this.extendByFat(mainBox, fat);
    var subBoxes = this.getSubBoxes(mainBox, fat);
    var intersectBoxes = this.filterIntersectBoxes(subBoxes, coordinates);
 ...
 * */
LineStringBoxer.prototype.getMainBox = function(coordinates) {
 ...
 * */
LineStringBoxer.prototype.filterIntersectBoxes = function(boxes, coordinates) {
    var intersectBoxes = [];

    boxes.forEach(function(oneLineSubBoxes) {
        var oneLineIntersectBoxes = [];
        oneLineSubBoxes.forEach(function(box) {
            if (LineStringBoxer.prototype.isIntersectOneBox(box, coordinates)) {
...
LineStringBoxer.prototype.isIntersectOneBox = function(box, coordinates) {
    var boxSides = [];
    var lineStringSides = [];
